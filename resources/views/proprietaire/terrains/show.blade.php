    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 space-y-4 md:space-y-0">
            <div class="flex items-center space-x-4">
                <a href="{{ route('proprietaire.terrains.index') }}" class="bg-gray-700 hover:bg-gray-600 text-white rounded-full w-10 h-10 flex items-center justify-center transition-colors duration-200 shadow-md">
                ...
                <table class="min-w-full divide-y divide-gray-700">
                    <thead class="bg-gray-900">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Heure</th>
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Montant</th>
                        </tr>
                    </thead>
                    <tbody class="bg-gray-800 divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-850 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex items-center">
                                    <div class="w-7 h-7 rounded-full bg-gray-700 flex items-center justify-center mr-2">
                                        <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                        </svg>
                                    </div>
                                    <span class="text-gray-300">{{ $reservation->user->name ?? 'N/A' }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 text-xs font-semibold rounded-full
                                    {{ $reservation->status === 'confirmee' ? 'bg-green-900 text-green-200' : 
                                     ($reservation->status === 'en_attente' ? 'bg-yellow-900 text-yellow-200' : 
                                     ($reservation->status === 'annulee' ? 'bg-red-900 text-red-200' : 'bg-blue-900 text-blue-200')) }}">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-400">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p>Aucune réservation trouvée pour ce terrain.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
