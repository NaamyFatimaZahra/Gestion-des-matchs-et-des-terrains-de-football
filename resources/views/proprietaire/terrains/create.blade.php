...
<div class="container mx-auto px-4 py-8 mt-[4rem] text-gray-300">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('proprietaire.terrains.index') }}" class="bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center transition duration-300">
    ...
    <div class="bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-gray-700">
        ...
        <div class="bg-red-600 py-4 px-6 flex items-center">
            ...
            <div>
                ...
                <p class="text-red-100 text-sm">Remplissez les informations ci-dessous</p>
            </div>
        </div>
   </div>
        ...
        <form action="{{ route('proprietaire.terrain.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            @if ($errors->any())
                <div class="bg-red-900/50 border-l-4 border-red-600 text-red-100 px-4 py-3 rounded mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-5">
                    <!-- Nom du terrain -->
                    <div class="space-y-2">
                        <label for="name" class="flex items-center text-sm font-medium text-gray-300">
                            <i class="fas fa-tag text-red-500 mr-2"></i>
                            Nom du terrain <span class="text-red-500 ml-1">*</span>
                        </label>
                    ...
                    <!-- Description -->
                    <div class="space-y-2">
                        <label for="description" class="flex items-center text-sm font-medium text-gray-300">
                    ...
                    <!-- Capacité -->
                    <div class="space-y-2">
                        <label for="capacity" class="flex items-center text-sm font-medium text-gray-300">
                    ...
                    <!-- Prix -->
                    <div class="space-y-2">
                        <label for="price" class="flex items-center text-sm font-medium text-gray-300">
                            <i class="fas fa-money-bill-wave text-red-500 mr-2"></i>
                            Prix par heure (MAD) <span class="text-red-500 ml-1">*</span>
                        </label>
                        <div class="relative">
                            <input type="number" name="price" id="price" required min="0" step="0.01" 
                                class="bg-gray-900 border border-gray-700 rounded-lg pl-10 pr-4 py-3 w-full text-white focus:border-red-500 focus:ring-1 focus:ring-red-500 transition duration-300"
                                placeholder="Ex: 300">
                ...
                <div class="space-y-5">
                    <!-- Type de surface -->
                    <div class="space-y-2">
                        <label for="surface" class="flex items-center text-sm font-medium text-gray-300">
                            <i class="fas fa-layer-group text-red-500 mr-2"></i>
                            Type de surface <span class="text-red-500 ml-1">*</span>
                        </label>
                   ...
                   <!-- Ville -->
                    <div class="space-y-2">
                       ...
                       <select id="city" name="city" class="bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 w-full text-white focus:border-red-500 focus:ring-1 focus:ring-red-500 transition duration-300" required>
                    ...
                    <!-- Adresse -->
                    <div class="space-y-2">
                        <label for="adress" class="flex items-center text-sm font-medium text-gray-300">
            ...
            <div id="localisation" class="mt-6 p-5 bg-gray-700/20 rounded-xl border border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        <label for="contact" class="text-sm font-medium text-gray-300">Numéro de contact</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div id="photo" class="mt-6 p-5 bg-gray-700/20 rounded-xl border border-gray-700">
                <h3 class="text-white font-medium mb-4 flex items-center">
                    <i class="fas fa-images text-red-500 mr-2"></i>
                    Photos du terrain
                </h3>
                ...
                <div class="border-2 border-dashed border-gray-700 rounded-lg p-6 text-center relative">
                    ...
                    <label for="imageUpload" class="cursor-pointer peer">
                        <div class="w-16 h-16 rounded-full bg-gray-800 flex items-center justify-center mx-auto mb-3">
                ...
                <p><span class="text-red-500">*Info:</span> si tu veut ajouter plusier image clisk sur controle et choisie votre image</p>
                <div id="image-preview"  class="mt-3 grid grid-cols-3 md:grid-cols-5 gap-2"></div>
                
            </div>
            
            <!-- Services disponibles -->
            <div id="service" class="mt-6 p-5 bg-gray-700/20 rounded-xl border border-gray-700">
                <h3 class="text-white font-medium mb-4 flex items-center">
                    <i class="fas fa-concierge-bell text-red-500 mr-2"></i>
                    Services disponibles
                </h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    @foreach ($services as $service)
                        <div class="relative">
                            ...
                            <label for="service_{{ $service->id }}" class="flex items-center p-3 bg-gray-900 border border-gray-700 rounded-lg cursor-pointer peer-checked:border-red-500 peer-checked:bg-red-600/20 transition duration-300">
                                <div class="w-8 h-8 rounded-md bg-gray-800 flex items-center justify-center mr-3 peer-checked:bg-red-600">
    ...
    <div class="mt-6 flex justify-center">
        <div class="flex items-center space-x-2 text-sm text-gray-500">
            <span class="text-red-500">Étape 1</span>
        ...
        reader.onload = function(event) {
            ...
            preview.innerHTML += `
                <div class="relative">
                    ...
                    <button type="button" class="absolute top-1 right-1 bg-red-600 text-white rounded-full w-5 h-5 flex items-center justify-center"
