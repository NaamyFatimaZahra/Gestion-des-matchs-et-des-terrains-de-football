   ...
   <!-- POP UP PLAYERS-->
      ...
      >
        ...
        >
          ...
          <div
            id="content_pop_up"
            class="flex flex-col flex-wrap h-[80%] px-7 justify-center items-center gap-8 text-white overflow-x-auto scrollbar-thin scrollbar-thumb-[#580a21] scrollbar-track-gray-700 scrollbar-thumb-rounded-full scrollbar-track-rounded-full"
          >
  ...
  <!-- POP UP TERRAINS-->
      ...
      >
        ...
        >
          ...
          <div
            id="content_terrains"
            class="flex justify-center gap-4 w-full h-[100%] items-center px-6  overflow-x-auto scrollbar-thin scrollbar-thumb-[#580a21] scrollbar-track-gray-700 scrollbar-thumb-rounded-full scrollbar-track-rounded-full"
          >
...
>
    ...
    class="p-6 h-[calc(100%-80px)] w-full  overflow-y-auto scrollbar-thin scrollbar-thumb-[#580a21] scrollbar-track-gray-700 scrollbar-thumb-rounded-full scrollbar-track-rounded-full"
>
    <div class="text-center text-white col-span-full flex flex-col items-center justify-center">
