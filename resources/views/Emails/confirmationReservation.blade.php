    ...
    <div class="max-w-2xl mx-auto p-5">
        <div class="bg-white rounded-lg overflow-hidden shadow-lg">
            ...
            <div class="p-6 bg-gray-50">
                <p class="text-gray-800 mb-4">Bonjour {{ $player ? $player->name : 'cher client' }},</p>
                ...
                <ul class="bg-white rounded-lg border border-gray-200 text-gray-700 mb-6 px-6 py-4">
                    <li class="py-1">
                        ...
                        <span>{{ $reservation->terrain ? $reservation->terrain->name : 'N/A' }}</span>
                    </li>
                    <li class="py-1">
                    ...
                    <li class="py-1">
                        ...
                        <span>{{ $reservation->squad && $reservation->squad->players ? $reservation->squad->players->count() : 'N/A' }}</span>
                    </li>
                    <li class="py-1">
                        <span class="font-semibold">Prix total :</span>
                        <span>{{ $reservation->terrain ? $reservation->terrain->price : 'N/A' }} DH</span>
                    </li>
                </ul>
