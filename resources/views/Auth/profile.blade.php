...
@section('content')
    ...
    <div class="container mx-auto p-4 mt-9">
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-md bg-gray-800 flex items-center justify-center mr-3">
                                <i class="fas fa-map-marker-alt text-[#580a21]"></i>
                            </div>
                            <div>
                                <p class="text-sm text-gray-400">Ville</p>
                                <p class="font-medium text-white">{{ $user->city }}</p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-md bg-gray-800 flex items-center justify-center mr-3">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-white">{{ $user->phone_number ?? 'Non renseigné' }}</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-[#1c1d22] rounded-lg p-6 border border-gray-800 shadow-md">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-medium text-white">Informations personnelles</h3>
                </div>
                
                <div class="space-y-4">
                    <div class="bg-[#212228] rounded-lg p-4">
            ...
            <div class="bg-[#1c1d22] rounded-lg p-6 border border-gray-800 shadow-md">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-medium text-white">Profil</h3>
                </div>
                
                <div class="bg-[#212228] rounded-lg p-4 mb-4">
                ...
                <div class="bg-[#212228] rounded-lg p-4 mb-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-white">{{ $user->role->name ?? 'Utilisateur' }}</span>
                    </div>
                </div>
                ...
                <div class="bg-[#212228] rounded-lg p-4 mb-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-white">{{ \Carbon\Carbon::parse($user->created_at)->format('d/m/Y') }}</span>
                    </div>
                </div>
                ...
                <div class="bg-[#212228] rounded-lg p-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-white">{{ \Carbon\Carbon::parse($user->updated_at)->format('d/m/Y à H:i') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-4 mt-8">
            ...
            <button onclick="reloadPage()" class="bg-[#212228] text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition-all flex items-center">
