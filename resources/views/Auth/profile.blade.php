...
@section('content')
    ...
    <div class="container mx-auto px-4 py-6 max-w-screen-xl">
            ...
            <div class="flex flex-col items-center sm:flex-row sm:items-start">
                ...
                <div class="flex-1 text-center sm:text-left">
                    ...
                    <div class="flex justify-center sm:justify-start">
                        <a href="{{ route('profile.edit') }}" class="bg-[#420718e2] text-white px-4 py-2 rounded-lg hover:bg-[#2d050fe2] transition-all flex items-center text-sm">
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 mt-6 sm:mt-8">
            <a href="{{ route('profile.edit') }}" class="w-full sm:w-auto bg-[#420718e2] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-[#2d050fe2] transition-all flex items-center justify-center">
